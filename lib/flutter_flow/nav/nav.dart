      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CheckoutWidget(
            deliveryOption: params.getParam(
              'deliveryOption',
              ParamType.String,
            ),
            isGetinplace: params.getParam(
              'isGetinplace',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'AdminDashboard')
        ...
        FFRoute(
          ...
          builder: (context, params) => ProductPageWidget(
            ...
            discountId: params.getParam(
              'discountId',
              ParamType.String,
            ),
            isDiscount: params.getParam(
              'isDiscount',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          name: 'signUp_Editio1',
          path: '/signUpEditio1',
          builder: (context, params) => SignUpEditio1Widget(
        ...
        FFRoute(
          ...
          path: '/contactUpdateInfo',
          builder: (context, params) => const ContactUpdateInfoWidget(),
        ),
        FFRoute(
          name: 'My_orderDetail',
          path: '/order_detail',
          builder: (context, params) => MyOrderDetailWidget(
            orderDetailId: params.getParam(
              'orderDetailId',
              ParamType.String,
            ),
          ),
