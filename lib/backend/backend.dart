...
/// Functions to query AdvertismentBannerCollectionRecords (as a Stream and as a Future).
Future<int> queryAdvertismentBannerCollectionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AdvertismentBannerCollectionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AdvertismentBannerCollectionRecord>>
    queryAdvertismentBannerCollectionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
        queryCollection(
          AdvertismentBannerCollectionRecord.collection,
          AdvertismentBannerCollectionRecord.fromSnapshot,
          queryBuilder: queryBuilder,
          limit: limit,
          singleRecord: singleRecord,
        );

Future<List<AdvertismentBannerCollectionRecord>>
...
/// Functions to query AdminInfoRecords (as a Stream and as a Future).
Future<int> queryAdminInfoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<AdminInfoRecord>> queryAdminInfoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<AdminInfoRecord>> queryAdminInfoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
