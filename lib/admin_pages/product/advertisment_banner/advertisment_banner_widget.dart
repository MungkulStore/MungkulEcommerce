...
class _AdvertismentBannerWidgetState extends State<AdvertismentBannerWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdvertismentBannerCollectionRecord>>(
      stream: queryAdvertismentBannerCollectionRecord(
        queryBuilder: (advertismentBannerCollectionRecord) =>
            advertismentBannerCollectionRecord.where(
          'product_id',
          isEqualTo: widget.bannerId,
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<AdvertismentBannerCollectionRecord>
            advertismentBannerAdvertismentBannerCollectionRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final advertismentBannerAdvertismentBannerCollectionRecord =
            advertismentBannerAdvertismentBannerCollectionRecordList.isNotEmpty
                ? advertismentBannerAdvertismentBannerCollectionRecordList.first
                : null;
