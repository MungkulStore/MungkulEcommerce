...
class _ProductListWidgetState extends State<ProductListWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        _model.productsList =
            _model.productOutput!.toList().cast<ProductsRecord>();
      });
    });
