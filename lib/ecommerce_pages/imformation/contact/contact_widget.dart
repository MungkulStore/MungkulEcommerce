...
class _ContactWidgetState extends State<ContactWidget> {
  ...
  void initState() {
    ...
    _model.massageTextController ??= TextEditingController();
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: TextFormField(
                                                          ...
                                                          maxLines: 7,
                                                          validator: _model
                                                              .massageTextControllerValidator
                                                              .asValidator(
                                                                  context),
                                                        ),
                                                      ),
                                              ...
                                              onPressed: () async {
                                                await launchUrl(Uri(
                                                    ...
                                                    query: {
                                                      'subject': 'Contact Us',
                                                      'body':
                                                          '${_model.fullnameTextController.text}${_model.emailTextController.text}${_model.phoneNumberTextController.text}${_model.massageTextController.text}',
                                                    }
                                                        .entries
                                                        .map((MapEntry<String,
                                                                    String>
