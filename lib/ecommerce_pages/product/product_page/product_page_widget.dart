      ...
      'conditionalBuilderOnActionTriggerAnimation': AnimationInfo(
        ...
        effectsBuilder: () => [
          MoveEffect(
            ...
            delay: 0.0.ms,
            duration: 600.0.ms,
            begin: const Offset(0.0, 11.000000000000014),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  if ((_model.filteredProdutList.isEmpty) &&
                                      (_model.isLoaded == true)) {
                                    return Align(
                                      alignment: const AlignmentDirectional(0.0, 0.0),
                                      child: Container(
                                  ...
                                  } else if ((_model.filteredProdutList.isNotEmpty) &&
                                      (_model.isLoaded == true)) {
                                    return Container(
                                      width: 1040.0,
                                      decoration: const BoxDecoration(),
                                      child: Builder(
                                        builder: (context) {
                                          final productSearchResult = _model
                                              .filteredProdutList
                                              .toList();
                                            ...
                                            itemBuilder: (context,
                                              ...
                                              return ProductCardWidget(
                                                ...
                                                description:
                                                    productSearchResultItem
                                                        .description,
                                                status: productSearchResultItem
                                                    .status,
