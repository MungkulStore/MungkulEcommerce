...
class _MyOrderWidgetState extends State<MyOrderWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.emptyOrder = await queryOrderRecordOnce(
      ...
      setState(() {
        _model.filterOrder = _model.emptyOrder!.toList().cast<OrderRecord>();
      });
    });
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final ordersearch =
                                                _model.filterOrder.toList();
                                            return ListView.builder(
                                              padding: EdgeInsets.zero,
                                              primary: false,
                                              shrinkWrap: true,
                                              scrollDirection: Axis.vertical,
                                              itemCount: ordersearch.length,
                                              itemBuilder:
                                                  (context, ordersearchIndex) {
