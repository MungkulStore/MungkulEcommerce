...
class _MyOrderWidgetState extends State<MyOrderWidget> {
  ...
  void initState() {
    ...
    _model.adressTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.adress, ''),
      '0',
    ));
